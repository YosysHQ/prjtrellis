...
jobs = [
        # *
        {
            ...
            "cfg" : FuzzConfig(job="GLOBAL_ECLK", family="MachXO2", device="LCMXO2-7000HC", ncl="center-mux.ncl",
        ...
        {
            "netnames" : eclkbridge,
            "cfg" : FuzzConfig(job="GLOBAL_ECLKBRIDGE", family="MachXO2", device="LCMXO2-7000HC", ncl="center-mux.ncl",
                      tiles=["CENTER13:CENTER_EBR_CIB_4K", "CENTER_EBR29:CENTER_EBR",
                             "CENTER16:CENTER8", "CENTER15:CENTER7", "CENTER14:CENTER6",
                             "CENTER11:CENTERB", "CENTER12:CENTERC"]),
            "prefix" : "7000_",
        ...
        {
            "netnames" : dcm + dcc,
            "cfg" : FuzzConfig(job="GLOBAL_DCM_DCC", family="MachXO2", device="LCMXO2-7000HC", ncl="center-mux.ncl",
                      tiles=["CENTER13:CENTER_EBR_CIB_4K", "CENTER_EBR29:CENTER_EBR",
                             "CENTER16:CENTER8", "CENTER15:CENTER7", "CENTER14:CENTER6",
                             "CENTER11:CENTERB", "CENTER12:CENTERC"]),
            "prefix" : "7000_",
...

        {
            ...
            "cfg" : FuzzConfig(job="GLOBAL_HFSN", family="MachXO2", device="LCMXO2-7000HC", ncl="center-mux.ncl",
                      tiles=["CENTER13:CENTER_EBR_CIB_4K", "CENTER_EBR29:CENTER_EBR",
                             "CENTER16:CENTER8", "CENTER15:CENTER7", "CENTER14:CENTER6",
                             "CENTER11:CENTERB", "CENTER12:CENTERC"]),
            "prefix" : "7000_",
        ...
        # entrance to global network!
        {
            ...
            "cfg" : FuzzConfig(job="GLOBAL_DCC_OUT", family="MachXO2", device="LCMXO2-7000HC", ncl="center-mux.ncl",
                      tiles=["CENTER13:CENTER_EBR_CIB_4K", "CENTER_EBR29:CENTER_EBR",
                             "CENTER16:CENTER8", "CENTER15:CENTER7", "CENTER14:CENTER6",
                             "CENTER11:CENTERB", "CENTER12:CENTERC"]),
            "prefix" : "7000_",
