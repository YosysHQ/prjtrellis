...
jobs = [
        (FuzzConfig(job="TECLKSYNC0", family="MachXO2", device="LCMXO2-1200HC", ncl="empty.ncl",
                    tiles=["PT13:PIC_T_DUMMY_VIQ"]), "TECLKSYNC0"),
        (FuzzConfig(job="TECLKSYNC1", family="MachXO2", device="LCMXO2-1200HC", ncl="empty.ncl",
                    tiles=["PT13:PIC_T_DUMMY_VIQ"]), "TECLKSYNC1"),
        (FuzzConfig(job="BECLKSYNC0", family="MachXO2", device="LCMXO2-1200HC", ncl="empty.ncl",
                    tiles=["PB13:PIC_B_DUMMY_VIQ"]), "BECLKSYNC0"),
        (FuzzConfig(job="BECLKSYNC1", family="MachXO2", device="LCMXO2-1200HC", ncl="empty.ncl",
