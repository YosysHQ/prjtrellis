...
cfg = FuzzConfig(job="CIBEBR0ROUTE", family="MachXO2", device="LCMXO2-1200HC", ncl="cibroute.ncl", tiles=["CIB_R6C10:CIB_EBR0"])
...
def main():
    ...
    interconnect.fuzz_interconnect(config=cfg, location=(6, 10),
