...
jobs = [
    #0
    (FuzzConfig(job="GLB_UPDOWN26", family="MachXO2", device="LCMXO2-7000HC", ncl="tap.ncl",
                      tiles=["CIB_R13C10:CIB_EBR0"]), mk_nets((13, 10), (2, 6))),
    
    (FuzzConfig(job="GLB_UPDOWN15", family="MachXO2", device="LCMXO2-7000HC", ncl="tap.ncl",
                      tiles=["CIB_R13C13:CIB_EBR0"]), mk_nets((13, 13), (1, 5))),

    (FuzzConfig(job="GLB_UPDOWN04", family="MachXO2", device="LCMXO2-7000HC", ncl="tap.ncl",
                      tiles=["CIB_R13C16:CIB_EBR0"]), mk_nets((13, 16), (0, 4))),

    (FuzzConfig(job="GLB_UPDOWN37", family="MachXO2", device="LCMXO2-7000HC", ncl="tap.ncl",
                      tiles=["CIB_R13C7:CIB_EBR0"]),  mk_nets((13, 7),  (3, 7))),

    #4
    (FuzzConfig(job="CIB_EBR0_END2_DLL45_UPDOWN", family="MachXO2", device="LCMXO2-7000HC", ncl="tap.ncl",
                      tiles=["CIB_R13C1:CIB_EBR0_END2_DLL45"]), flatten_nets((13,1))),
    (FuzzConfig(job="CIB_EBR2_END1_UPDOWN", family="MachXO2", device="LCMXO2-7000HC", ncl="tap.ncl",
                      tiles=["CIB_R13C41:CIB_EBR2_END1"]), flatten_nets((13,41))),
    (FuzzConfig(job="CIB_EBR0_END2_DLL3_UPDOWN", family="MachXO2", device="LCMXO2-7000HC", ncl="tap.ncl",
                      tiles=["CIB_R20C1:CIB_EBR0_END2_DLL3"]), flatten_nets((20,1))),
    (FuzzConfig(job="CIB_EBR2_END1_SP_UPDOWN", family="MachXO2", device="LCMXO2-7000HC", ncl="tap.ncl",
