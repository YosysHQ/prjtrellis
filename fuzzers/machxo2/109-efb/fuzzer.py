...
jobs = [
        (FuzzConfig(job="EFB_1200", family="MachXO2", device="LCMXO2-1200HC", ncl="routing_1200.ncl",
                    tiles=["CIB_R1C4:CIB_CFG0"]), "1200_"),
        (FuzzConfig(job="EFB_2000", family="MachXO2", device="LCMXO2-2000HC", ncl="routing_2000.ncl",
                    tiles=["CIB_R1C4:CIB_CFG0"]), "2000_"),
        (FuzzConfig(job="EFB_4000", family="MachXO2", device="LCMXO2-2000HC", ncl="routing_4000.ncl",
                    tiles=["CIB_R1C4:CIB_CFG0"]), "4000_"),
        (FuzzConfig(job="EFB_7000", family="MachXO2", device="LCMXO2-7000HC", ncl="routing_7000.ncl",
                    tiles=["CIB_R1C4:CIB_CFG0"]), "7000_"),
]
