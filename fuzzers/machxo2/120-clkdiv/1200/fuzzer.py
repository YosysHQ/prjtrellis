...
jobs = [
        (FuzzConfig(job="TCLKDIV0", family="MachXO2", device="LCMXO2-1200HC", ncl="empty.ncl",
                    tiles=["PT13:PIC_T_DUMMY_VIQ"]), "TCLKDIV0"),
        (FuzzConfig(job="TCLKDIV1", family="MachXO2", device="LCMXO2-1200HC", ncl="empty.ncl",
                    tiles=["PT13:PIC_T_DUMMY_VIQ"]), "TCLKDIV1"),
        (FuzzConfig(job="BCLKDIV0", family="MachXO2", device="LCMXO2-1200HC", ncl="empty.ncl",
                    tiles=["PB13:PIC_B_DUMMY_VIQ"]), "BCLKDIV0"),
        (FuzzConfig(job="BCLKDIV1", family="MachXO2", device="LCMXO2-1200HC", ncl="empty.ncl",
