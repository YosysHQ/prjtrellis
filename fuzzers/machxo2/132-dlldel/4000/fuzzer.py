...
jobs = [
        (FuzzConfig(job="TDLLDEL", family="MachXO2", device="LCMXO2-4000HC", ncl="empty.ncl",
                    tiles=["PT16:PIC_T_DUMMY_VIQ"]), [("TDLLDEL0", "R0C16"), ("TDLLDEL1", "R0C16")]),
        (FuzzConfig(job="BDLLDEL", family="MachXO2", device="LCMXO2-4000HC", ncl="empty.ncl",
                    tiles=["PB16:PIC_B_DUMMY_VIQ_VREF"]), [("BDLLDEL0", "R22C16"), ("BDLLDEL1", "R22C16")]),

        (FuzzConfig(job="LDLLDEL", family="MachXO2", device="LCMXO2-4000HC", ncl="empty.ncl",
        ...
        #(FuzzConfig(job="RDLLDEL", family="MachXO2", device="LCMXO2-4000HC", ncl="empty.ncl",
