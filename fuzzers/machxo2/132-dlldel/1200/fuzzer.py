...
jobs = [
        (FuzzConfig(job="TDLLDEL", family="MachXO2", device="LCMXO2-1200HC", ncl="empty.ncl",
                    tiles=["PT13:PIC_T_DUMMY_VIQ"]), [("TDLLDEL0", "R0C13"), ("TDLLDEL1", "R0C13")]),
        (FuzzConfig(job="BDLLDEL", family="MachXO2", device="LCMXO2-1200HC", ncl="empty.ncl",
                    tiles=["PB13:PIC_B_DUMMY_VIQ"]), [("BDLLDEL0", "R12C13"), ("BDLLDEL1", "R12C13")]),

        (FuzzConfig(job="LDLLDEL", family="MachXO2", device="LCMXO2-1200HC", ncl="empty.ncl",
                    tiles=["CIB_R6C1:CIB_EBR0_END0"]), [("LDLLDEL0", "R6C0"), ("LDLLDEL1", "R6C0"), ("LDLLDEL2", "R6C0")]),
        (FuzzConfig(job="RDLLDEL", family="MachXO2", device="LCMXO2-1200HC", ncl="empty.ncl",
