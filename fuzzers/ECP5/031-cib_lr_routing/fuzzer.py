...
cfg = FuzzConfig(job="CIBROUTE", family="ECP5", device="LFE5U-25F", ncl="cibroute.ncl", tiles=["CIB_R21C1:CIB_LR"])
...
def main():
    ...
    interconnect.fuzz_interconnect(config=cfg, location=(21, 1),
