...
pio_tiles_l0 = {
    ...
    "LLC0PIC_VREF3" : (lambda a: False, lambda c: False, include_abcd_enum),
...
def main():
    ...
    for dest, pred in pio_tiles_l0.items():
        ...
        dbcopy.copy_enums_with_predicate("MachXO3", "LCMXO3LF-1300E", "PIC_L0", dest, pred[2], True)
    ...
    for dest, pred in pio_tiles_l0_9400.items():
        ...
        dbcopy.copy_enums_with_predicate("MachXO3", "LCMXO3LF-9400C", "PIC_L0", dest, pred[2])
    ...
    for dest, pred in pio_tiles_l1.items():
        ...
        dbcopy.copy_enums_with_predicate("MachXO3", "LCMXO3LF-4300C", "PIC_L1", dest, pred[2])
    ...
    for dest, pred in pio_tiles_l2.items():
        ...
        dbcopy.copy_enums_with_predicate("MachXO3", "LCMXO3LF-6900C", "PIC_L2", dest, pred[2])
    ...
    for dest, pred in pio_tiles_l3.items():
        ...
        dbcopy.copy_enums_with_predicate("MachXO3", "LCMXO3LF-2100C", "PIC_L3", dest, pred[2])

    for dest, pred in pio_tiles_r0.items():
        dbcopy.copy_muxes_with_predicate("MachXO3", "LCMXO3LF-1300E", "PIC_R0", dest, pred[0])
        dbcopy.copy_conns_with_predicate("MachXO3", "LCMXO3LF-1300E", "PIC_R0", dest, pred[1])
        dbcopy.copy_enums_with_predicate("MachXO3", "LCMXO3LF-1300E", "PIC_R0", dest, pred[2])
    ...
    for dest, pred in pio_tiles_r1.items():
        ...
        dbcopy.copy_enums_with_predicate("MachXO3", "LCMXO3LF-6900C", "PIC_R1", dest, pred[2])
    ...
    for dest, pred in pio_tiles_t_cib.items():
        ...
        dbcopy.copy_enums_with_predicate("MachXO3", "LCMXO3LF-1300E", "CIB_PIC_T0", dest, pred[2])

    for dest, pred in pio_tiles_b_cib.items():
        dbcopy.copy_muxes_with_predicate("MachXO3", "LCMXO3LF-1300E", "CIB_PIC_B0", dest, pred[0])
        dbcopy.copy_conns_with_predicate("MachXO3", "LCMXO3LF-1300E", "CIB_PIC_B0", dest, pred[1])
        dbcopy.copy_enums_with_predicate("MachXO3", "LCMXO3LF-1300E", "CIB_PIC_B0", dest, pred[2])
