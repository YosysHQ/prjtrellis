...
jobs = [(FuzzConfig(job="ECLKBRIDGECS1", family="MachXO3", device="LCMXO3LF-1300E", ncl="empty.ncl",
                    tiles=["CENTER6:CENTER_EBR_CIB"]), "ECLKBRIDGECS1"),
        (FuzzConfig(job="ECLKBRIDGECS0", family="MachXO3", device="LCMXO3LF-1300E", ncl="empty.ncl",
