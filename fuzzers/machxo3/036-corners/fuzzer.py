...
jobs = [
        ...
        #{
        #    "cfg": FuzzConfig(job="URC0ROUTE", family="MachXO3", device="LCMXO3-1300E",
        ...
        {
            "cfg": FuzzConfig(job="ULC0ROUTE", family="MachXO3", device="LCMXO3-1300E",
        ...
        #{
        #    "cfg": FuzzConfig(job="LLC0ROUTE", family="MachXO3", device="LCMXO3-1300E",
        ...
        #{
        #    "cfg": FuzzConfig(job="LRC0ROUTE", family="MachXO3", device="LCMXO3-1300E",
