...
jobs = [
        (FuzzConfig(job="TDLLDEL", family="MachXO3", device="LCMXO3LF-4300C", ncl="empty.ncl",
                    tiles=["PT16:PIC_T_DUMMY_VIQ"]), [("TDLLDEL0", "R0C16"), ("TDLLDEL1", "R0C16")]),
        (FuzzConfig(job="BDLLDEL", family="MachXO3", device="LCMXO3LF-4300C", ncl="empty.ncl",
