...
jobs = [
        (FuzzConfig(job="TDLLDEL", family="MachXO3", device="LCMXO3LF-2100C", ncl="empty.ncl",
                    tiles=["PT14:PIC_T_DUMMY_VIQ"]), [("TDLLDEL0", "R0C14"), ("TDLLDEL1", "R0C14")]),
        (FuzzConfig(job="BDLLDEL", family="MachXO3", device="LCMXO3LF-2100C", ncl="empty.ncl",
                    tiles=["PB14:PIC_B_DUMMY_VIQ_VREF"]), [("BDLLDEL0", "R15C14"), ("BDLLDEL1", "R15C14")]),

        (FuzzConfig(job="LDLLDEL", family="MachXO3", device="LCMXO3LF-2100C", ncl="empty.ncl",
                    tiles=["CIB_R8C1:CIB_EBR_DUMMY_END3"]), [("LDLLDEL0", "R8C0"), ("LDLLDEL1", "R8C0"), ("LDLLDEL2", "R8C0")]),
        (FuzzConfig(job="RDLLDEL", family="MachXO3", device="LCMXO3LF-2100C", ncl="empty.ncl",
