...
jobs = [
    ("R8C4", "EBR", FuzzConfig(job="EBROUTE0", family="MachXO3D", device="LCMXO3D-9400HC", ncl="empty.ncl",
                                tiles=["EBR_R8C4:EBR0", "EBR_R8C5:EBR1", "EBR_R8C6:EBR2"])),
    ("R8C1", "EBR", FuzzConfig(job="EBROUTE0", family="MachXO3D", device="LCMXO3D-9400HC", ncl="empty.ncl",
...
def main():
    ...
    for job in jobs:
        ...
        nonrouting.fuzz_enum_setting(cfg, "{}.MODE".format(ebr), ["PDPW8KC", "DP8KC", "FIFO8KB", "NONE"],
                                     ...
                                     ignore_bits=([("EBR_R8C5:EBR1", 0, 25), 
                                     ("EBR_R8C4:EBR0", 1, 2),("EBR_R8C4:EBR0", 1, 3),("EBR_R8C4:EBR0", 1, 4),("EBR_R8C4:EBR0", 1, 13),
                                     ("EBR_R8C1:EBR0_END", 1, 13),("EBR_R8C1:EBR0_END", 1, 14),("EBR_R8C1:EBR0_END", 1, 15),("EBR_R8C1:EBR0_END", 1, 24) ]))
