...
jobs = [
        # *
        {
            ...
            "cfg" : FuzzConfig(job="GLOBAL_ECLK", family="MachXO3D", device="LCMXO3D-9400HC", ncl="center-mux.ncl",
        ...
        {
            "netnames" : eclkbridge,
            "cfg" : FuzzConfig(job="GLOBAL_ECLKBRIDGE", family="MachXO3D", device="LCMXO3D-9400HC", ncl="center-mux.ncl",
                      tiles=["CENTER15:CENTER_EBR_CIB_10K", "CENTER_EBR34:CENTER_EBR",
                             "CENTER18:CENTER8", "CENTER17:CENTER7", "CENTER16:CENTER6",
                             "CENTER13:CENTER9", "CENTER14:CENTERA"]),
            "prefix" : "9400D_",
        ...
        {
            "netnames" : dcm + dcc,
            "cfg" : FuzzConfig(job="GLOBAL_DCM_DCC", family="MachXO3D", device="LCMXO3D-9400HC", ncl="center-mux.ncl",
                      tiles=["CENTER15:CENTER_EBR_CIB_10K", "CENTER_EBR34:CENTER_EBR",
                             "CENTER18:CENTER8", "CENTER17:CENTER7", "CENTER16:CENTER6",
                             "CENTER13:CENTER9", "CENTER14:CENTERA"]),
            "prefix" : "9400D_",
...

        {
            ...
            "cfg" : FuzzConfig(job="GLOBAL_HFSN", family="MachXO3D", device="LCMXO3D-9400HC", ncl="center-mux.ncl",
                      tiles=["CENTER15:CENTER_EBR_CIB_10K", "CENTER_EBR34:CENTER_EBR",
                             "CENTER18:CENTER8", "CENTER17:CENTER7", "CENTER16:CENTER6",
                             "CENTER13:CENTER9", "CENTER14:CENTERA"]),
            "prefix" : "9400D_",
        ...
        # entrance to global network!
        {
            ...
            "cfg" : FuzzConfig(job="GLOBAL_DCC_OUT", family="MachXO3D", device="LCMXO3D-9400HC", ncl="center-mux.ncl",
                      tiles=["CENTER15:CENTER_EBR_CIB_10K", "CENTER_EBR34:CENTER_EBR",
                             "CENTER18:CENTER8", "CENTER17:CENTER7", "CENTER16:CENTER6",
                             "CENTER13:CENTER9", "CENTER14:CENTERA"]),
            "prefix" : "9400D_",
