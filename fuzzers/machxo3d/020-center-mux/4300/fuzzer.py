...
jobs = [
        # *
        {
            ...
            "cfg" : FuzzConfig(job="GLOBAL_ECLK", family="MachXO3D", device="LCMXO3D-4300HC", ncl="center-mux.ncl",
        ...
        {
            "netnames" : eclkbridge,
            "cfg" : FuzzConfig(job="GLOBAL_ECLKBRIDGE", family="MachXO3D", device="LCMXO3D-4300HC", ncl="center-mux.ncl",
                      tiles=["CENTER11:CENTER_EBR_CIB_4K", "CENTER_EBR24:CENTER_EBR",
                             "CENTER14:CENTER8", "CENTER13:CENTER7", "CENTER12:CENTER6",
                             "CENTER9:CENTERB", "CENTER10:CENTERC"]),
            "prefix" : "4300D_",
        ...
        {
            "netnames" : dcm + dcc,
            "cfg" : FuzzConfig(job="GLOBAL_DCM_DCC", family="MachXO3D", device="LCMXO3D-4300HC", ncl="center-mux.ncl",
                      tiles=["CENTER11:CENTER_EBR_CIB_4K", "CENTER_EBR24:CENTER_EBR",
                             "CENTER14:CENTER8", "CENTER13:CENTER7", "CENTER12:CENTER6",
                             "CENTER9:CENTERB", "CENTER10:CENTERC"]),
            "prefix" : "4300D_",
...

        {
            ...
            "cfg" : FuzzConfig(job="GLOBAL_HFSN", family="MachXO3D", device="LCMXO3D-4300HC", ncl="center-mux.ncl",
                      tiles=["CENTER11:CENTER_EBR_CIB_4K", "CENTER_EBR24:CENTER_EBR",
                             "CENTER14:CENTER8", "CENTER13:CENTER7", "CENTER12:CENTER6",
                             "CENTER9:CENTERB", "CENTER10:CENTERC"]),
            "prefix" : "4300D_",
        ...
        # entrance to global network!
        {
            ...
            "cfg" : FuzzConfig(job="GLOBAL_DCC_OUT", family="MachXO3D", device="LCMXO3D-4300HC", ncl="center-mux.ncl",
                      tiles=["CENTER11:CENTER_EBR_CIB_4K", "CENTER_EBR24:CENTER_EBR",
                             "CENTER14:CENTER8", "CENTER13:CENTER7", "CENTER12:CENTER6",
                             "CENTER9:CENTERB", "CENTER10:CENTERC"]),
            "prefix" : "4300D_",
