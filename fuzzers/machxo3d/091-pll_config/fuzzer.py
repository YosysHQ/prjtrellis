...
jobs = [
    ("LPLL", FuzzConfig(job="GPLL_L0", family="MachXO3D", device="LCMXO3D-9400HC", ncl="empty.ncl",
                           tiles=["PT1:GPLL_L0"])),
    ("RPLL", FuzzConfig(job="GPLL_R0", family="MachXO3D", device="LCMXO3D-9400HC", ncl="empty.ncl",
                           tiles=["PT49:GPLL_R0"])),
]
