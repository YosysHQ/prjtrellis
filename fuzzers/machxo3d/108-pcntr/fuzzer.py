...
cfg = FuzzConfig(job="PCNTR", family="MachXO3D", device="LCMXO3D-9400HC", ncl="empty.ncl",
                  tiles=["PT4:CFG0", "PT5:CFG1", "PT6:CFG2", "PT7:CFG3", "PT8:PIC_T_DUMMY_OSC"])

rcfg = FuzzConfig(job="PCNTR", family="MachXO3D", device="LCMXO3D-9400HC", ncl="pcntr_routing.ncl",
