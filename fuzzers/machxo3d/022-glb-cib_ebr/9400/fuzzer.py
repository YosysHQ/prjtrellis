...
jobs = [
    (FuzzConfig(job="CIB_EBR0_END0_DLL5_UPDOWN", family="MachXO3D", device="LCMXO3D-9400HC", ncl="tap.ncl",
                      tiles=["CIB_R8C1:CIB_EBR0_END0_DLL5"]), flatten_nets((8,1))),
    (FuzzConfig(job="CIB_EBR2_END1_SP_UPDOWN", family="MachXO3D", device="LCMXO3D-9400HC", ncl="tap.ncl",
                      tiles=["CIB_R8C49:CIB_EBR2_END1_SP"]), flatten_nets((8,49))),

    (FuzzConfig(job="CIB_EBR0_END0_DLL3_UPDOWN", family="MachXO3D", device="LCMXO3D-9400HC", ncl="tap.ncl",
