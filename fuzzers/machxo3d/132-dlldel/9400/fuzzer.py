...
jobs = [
        (FuzzConfig(job="TDLLDEL", family="MachXO3D", device="LCMXO3D-9400HC", ncl="empty.ncl",
                    tiles=["PT25:PIC_T_DUMMY_VIQ"]), [("TDLLDEL0", "R0C25"), ("TDLLDEL1", "R0C25")]),
        (FuzzConfig(job="BDLLDEL", family="MachXO3D", device="LCMXO3D-9400HC", ncl="empty.ncl",
                    tiles=["PB25:PIC_B_DUMMY_VIQ_VREF"]), [("BDLLDEL0", "R31C25"), ("BDLLDEL1", "R31C25")]),

        (FuzzConfig(job="LDLLDEL", family="MachXO3D", device="LCMXO3D-9400HC", ncl="empty.ncl",
        ...
        (FuzzConfig(job="RDLLDEL", family="MachXO3D", device="LCMXO3D-9400HC", ncl="empty.ncl",
