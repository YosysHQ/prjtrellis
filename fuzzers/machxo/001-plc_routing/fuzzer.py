...
cfg = FuzzConfig(job="PLCROUTE", family="MachXO", device="LCMXO2280C", ncl="plc2route.ncl", tiles=["R12C15:PLC"])
...
def main():
    ...
    interconnect.fuzz_interconnect(config=cfg, location=(12, 15),
