...
cfg = FuzzConfig(job="FPLCROUTE", family="MachXO", device="LCMXO2280C", ncl="plc2route.ncl", tiles=["R6C14:FPLC"])
...
def main():
    ...
    interconnect.fuzz_interconnect(config=cfg, location=(6, 14),
